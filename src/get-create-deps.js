 ...
 *
 * Synchronously configures and returns an instance of module-deps-noio (a fork of module-deps that you can provide with a custom readFile method upon instantiation).
 */
